...
#define DELTA_DIAGONAL_ROD 195.0 //186 mm   NCKU

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 142.00 // mm  NCKU

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 34.00 // mm   NCKU

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 23.00 // mm    NCKU
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER add_homeing[0]//2.5//0.1  // Increase this if the first layer is too thin.
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 2.5//1  //How much the extruder will be raised when traveling from between next probing points
...
#define MANUAL_HOME_POSITIONS  // If defined3, MANUAL_*_HOME_POS below will be used
...
#define XYZ_FULL_STEPS_PER_ROTATION 200    //NCKU
#define XYZ_MICROSTEPS 16    //NCKU
#define XYZ_BELT_PITCH 2    //NCKU mm
#define XYZ_PULLEY_TEETH 36    //NCKU 同步輪
#define XYZ_STEPS (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))

#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 96.1}
